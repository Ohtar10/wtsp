...
export SPARK_SUBMIT_OPTIONS="--driver-memory 2G --packages databricks:spark-deep-learning:1.5.0-spark2.4-s_2.11"
...
# export PYTHONPATH
export PYTHONPATH=$PYTHONPATH:/root/.ivy2/jars/databricks_spark-deep-learning-1.5.0-spark2.4-s_2.11.jar
